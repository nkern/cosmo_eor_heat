...
Tvir            = 6e4                      		# Fiducial value for Tvir
zeta            = 51.0                     		# Fiducial value for zeta
Rmfp            = 20.0                     		# Fiducial value for Rmfp

fX				= 2.1							# Fiducial value for fX
aX				= 2.0							# Fiducial value for aX
...
N_samples		= 20000							# Number of samples to draw from multi-Gaussian or to use in training
eval_samples	= np.arange(0,20000)				# Total number of samples in dataset, train + cv (excluding fiducial)
N_train			= 20000							# Samples to train on
...
base_direc      = 'param_space/lhs/'                        # directory that opens up to 21cmFAST realizations
